...
def evaluate(config, args, net, train_step=None, datapath="", split_file=None,
    ...
    for i, scene in enumerate(scenes):
        ...
        for trial in range(trials):
            ...
            tss_file = os.path.join(datapath_val, f"tss_imgs_us_{side}.txt")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default="config/dataset_configs/default_rgb.yaml") # for DPVO settings
    ...
    print("Running eval_hku.py with config...")
    print(cfg)
