...
from devo.plot_utils import plot_trajectory, save_trajectory_tum_format
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default="config/dataset_configs/default_rgb.yaml")
